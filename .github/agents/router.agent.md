---
name: Router Agent
description: "Use when: you need to intelligently route requests, tasks, or data to the appropriate specialized agent."
---
...
- Route each sub‑tack to the appropriate specialist  
